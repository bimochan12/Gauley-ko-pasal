...
<div class="admin-container">
    ...
    <div class="danger-zone">
        ...
        <p>
            Permanently remove this seller account
            from Gauley Ko Pasal.
        </p>
        <div class="danger-warning">
            <strong>
                What happens when you delete this seller?
            </strong>
            <br><br>
            • The seller will no longer be able to log in.
            <br>
            • Pending and Processing orders containing
            this seller's products will be cancelled.
            <br>
            • The cancellation reason will be recorded as
            <strong>
                "Unauthorized seller"
            </strong>.
            <br>
            • The customer's order history will remain
            available.
        </div>
        <a
            href="delete_seller.php?id=<?php echo (int) $seller["user_id"]; ?>"
            class="delete-seller-button"
            onclick="return confirm(
                'WARNING: Are you sure you want to permanently delete this seller account?\\n\\nAny Pending or Processing orders containing this seller\\'s products will be cancelled.\\n\\nCancellation reason: Unauthorized seller\\n\\nThis action cannot be undone.'
            );"
        >
